...
@section('page_title', 'Brgy Committee Positions')
        ...
        <div
            ...
            <div class="flex flex-col md:flex-row items-center justify-between p-4 border-b dark:border-gray-700 gap-3">
                ...
                <button type="button" data-modal-target="default-modal" data-modal-toggle="default-modal"
                    ...
                    </svg> Add New Committee Position
                </button>
            </div>
                ...
                <table class="w-full text-sm text-left">
                    <thead class="bg-gray-50 dark:bg-gray-700 text-xs uppercase">
                        <tr>
                            ...
                            <th class="px-6 py-4">Committee Position Name</th>
                            <th class="px-6 py-4 text-right">Actions</th>
                        </tr>
                    </thead>

                    <tbody class="divide-y">
                        @forelse ($brgy_committee as $committee)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            <td class="px-6 py-4">{{ $committee->id }}</td>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.committee-delete', $committee->id) }}">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 border-t flex justify-between">
                <p class="text-xs font-bold text-gray-500">
                    Total Positions: {{ $brgy_committee->count() }}
                </p>
            </div>
    ...
    <div id="default-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="mx-auto w-full max-w-2xl">
            <div
                ...
                <!-- FORM -->
                <form method="POST" action="{{ route('admin.committee-positions-store') }}">
                    @csrf
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            <label for="committee_name"
                                ...
                                Barangay Committee Position Name
                            </label>

                            <input type="text" name="committee_name" id="committee_name"
                                value="{{ old('committee_name') }}" class="w-full p-3 bg-gray-50 border border-gray-300 rounded-lg
                                   focus:ring-blue-500 focus:border-blue-500 text-sm"
                                placeholder="e.g. Peace and Order for Public Safety" required>
